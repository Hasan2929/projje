...
<script src="https://unpkg.com/nprogress@0.2.0/nprogress.js"></script>
    ...
    <!-- ============== Google Services & Ads ============== -->
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2399127081177956" crossorigin="anonymous"></script>
    <script async src="https://www.googlesagmanager.com/gtag/js?id=G-54VGJRYN42"></script>
    <script>
...
<body data-page-title="home_page_title">
    ...
    <!-- ============== Header ============== -->
   <!-- ========================================================== -->
<!-- ===       الكود النهائي للهيدر التفاعلي المتغير       === -->
<!-- ========================================================== -->
<header class="header" id="main-header">
    ...
    <!-- ========================================================== -->
<!-- ===  الكود النهائي للصفحة الرئيسية (Hero Grid + Slider)  === -->
<!-- ========================================================== -->
<main class="main-content">
    
    <!-- === القسم العلوي الجديد (Hero Grid) === -->
    <section class="hero-grid-section">
        ...
        <div class="container">
            <div class="hero-grid-container">
                ...
                <!-- 1. العمود الأيمن الكبير (يحتوي الآن على السلايدر) -->
                <div class="hero-main-panel">
                    
                    <div class="featured-slider" style="height: 100%; min-height: initial;">
                        <div class="slider-container">
                            <div class="slider-wrapper" id="sliderWrapper">
                                <!-- Slides are loaded dynamically via JavaScript -->
                            </div>
                            <div class="slider-dots" id="sliderDots">
                                <!-- Dots are loaded dynamically via JavaScript -->
                            </div>
                ...
                <!-- 2. العمود الأيسر الصغير (للبرامج المميزة) -->
                <div class="hero-side-panel">
                    <div class="side-panel-header">
        <h3 data-translate="hero_whats_new"></h3> <!-- << التعديل هنا -->
                        <a href="software.php">زیاتر ببینە</a>
                    </div>
                    <div class="side-panel-list" id="hero-new-programs">
    ...
    <!-- ... بقية أقسام الصفحة الرئيسية (Featured Categories, Top Games, etc.) تبدأ من هنا ... -->
    
    <!-- ========================================================== -->
<!-- ===           قسم الفئات المميزة الجديد             === -->
<!-- ========================================================== -->
<section class="featured-categories-section">
    <div class="container">
        <div class="categories-grid">
            <a href="software.php?filter=system" class="category-card">
                <i class="fas fa-cogs"></i>
                <span data-translate="cat_system"></span>
            </a>
            <a href="software.php?filter=montage" class="category-card">
                <i class="fas fa-video"></i>
                <span data-translate="cat_montage"></span>
            </a>
            <a href="games.php?filter=Action" class="category-card">
                <i class="fas fa-bomb"></i>
                <span data-translate="cat_action"></span>
            </a>
            <a href="games.php?filter=Sports" class="category-card">
                <i class="fas fa-futbol"></i>
                <span data-translate="cat_sports"></span>
            </a>
            <a href="games.php?filter=Racing" class="category-card">
                <i class="fas fa-car-side"></i>
                <span data-translate="cat_racing"></span>
            </a>
            <a href="software.php" class="category-card">
                <i class="fas fa-layer-group"></i>
                <span data-translate="cat_all_software"></span>
            </a>
        </div>
    </div>
</section>
...
<!-- ========================================================== -->
<!-- ========================================================== -->
<!-- ===      التصميم النهائي للأقسام (مع أزرار التمرير)     === -->
<!-- ========================================================== -->
...
<div class="container">
    <div class="content-section-wrapper">
        <div class="section-header-box">
            <h2 class="section-title" data-translate="whats_new"></h2>
            <a href="software.php" class="see-more-btn" data-translate="see_more">زیاتر ببینە</a>

        </div>
        <div class="programs-horizontal-container">
            <button class="horizontal-scroll-btn prev" onclick="scrollHorizontal('newProgramsGrid', -1)"><i class="fas fa-chevron-left"></i></button>
            <div id="newProgramsGrid" class="programs-horizontal-wrapper">
                <!-- سيتم ملء المحتوى هنا بواسطة JavaScript -->
            </div>
            <button class="horizontal-scroll-btn next" onclick="scrollHorizontal('newProgramsGrid', 1)"><i class="fas fa-chevron-right"></i></button>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="content-section-wrapper">
        <div class="section-header-box">
            <h2 class="section-title" data-translate="top_games"></h2>
            <a href="games.php" class="see-more-btn" data-translate="see_more">زیاتر ببینە</a>
        </div>
        <div class="programs-horizontal-container">
            <button class="horizontal-scroll-btn prev" onclick="scrollHorizontal('topGamesGrid', -1)"><i class="fas fa-chevron-left"></i></button>
            <div id="topGamesGrid" class="programs-horizontal-wrapper">
                <!-- سيتم ملء المحتوى هنا بواسطة JavaScript -->
            </div>
            <button class="horizontal-scroll-btn next" onclick="scrollHorizontal('topGamesGrid', 1)"><i class="fas fa-chevron-right"></i></button>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="content-section-wrapper">
        <div class="section-header-box">
            <h2 class="section-title" data-translate="top_software"></h2>
            <a href="software.php" class="see-more-btn" data-translate="see_more">زیاتر ببینە</a>
        </div>
        <div class="programs-horizontal-container">
            <button class="horizontal-scroll-btn prev" onclick="scrollHorizontal('topSoftwareGrid', -1)"><i class="fas fa-chevron-left"></i></button>
            <div id="topSoftwareGrid" class="programs-horizontal-wrapper">
                <!-- سيتم ملء المحتوى هنا بواسطة JavaScript -->
            </div>
            <button class="horizontal-scroll-btn next" onclick="scrollHorizontal('topSoftwareGrid', 1)"><i class="fas fa-chevron-right"></i></button>
        </div>
    </div>
</div>
